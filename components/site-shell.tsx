  ...
  return (
    <main className="min-h-screen bg-[#f8f4ec]">
      <header className="mx-auto flex w-full max-w-7xl items-center justify-between px-5 py-5 sm:px-8">
        ...
        <Link
          href="/app"
          className="inline-flex h-10 items-center gap-2 rounded-full bg-ink px-4 text-sm font-semibold text-white transition hover:bg-stone-800 hover:scale-[0.98]"
        >
